        ...
        <div class="third-bottom" v-show="data!=null?(
            ...
            <div class="third-bottom-box" :class="swA">
                <div class="third-bottom-item">
                    ...
                    <h3>{{languageType1[swA].bottom0H}}</h3>
                    <p>{{languageType1[swA].bottom0P}}</p>
                </div>
                <div class="third-bottom-border"></div>
                <div class="third-bottom-item">
                    <img src="../../assets/images/third/2019-12-18/money.png" alt="">
                    <h3>{{languageType1[swA].bottom1H}}</h3>
                    <p>{{languageType1[swA].bottom1P}}</p>
                </div>
                <div class="third-bottom-border"></div>
                <div class="third-bottom-item">
                    <img src="../../assets/images/third/2019-12-18/suo.png" alt="">
                    <h3>{{languageType1[swA].bottom2H}}</h3>
                    <p>{{languageType1[swA].bottom2P0}}{{data!=null?data.coinType?data.coinType.toUpperCase():data.coin.toUpperCase():''}}{{languageType1[swA].bottom2P1}}</p>
                </div>
            </div>
        </div>
    </div>

    ...
    <div>
        <div id="third-one" v-if="data!=null?data.type==0?true:false:false">
            <div class="third-one-time">
                ...
                <div class="right-tip" :class="$parent.swA">
                    ...
                    <h3>{{languageType0[$parent.swA].rightTipHLeft}}<span>{{languageType0[$parent.swA].rightTipHCenter}}</span>{{languageType0[$parent.swA].rightTipHRight}}</h3>
                </div>
            </div>
            <div class="third-one-box">
                ...
                <div class="third-one-item">
                    ...
                    <div class="text-box">
                        <p>{{data!=null?data.amount:''}} {{data!=null?data.coinType.toUpperCase():''}}</p>
                    </div>
                </div>
                <div class="third-one-item">
        ...
        <div class="gate-way-one" v-if="data!=null?data.type==1?true:false:false">
            ...
            <div class="btn">
                ...
                <button class="next" @click="nextFun1">
                    {{languageType1[$parent.swA].btnDeposit}}
                    <p>{{languageType1[$parent.swA].btnInfo01}}<span>{{languageType1[$parent.swA].btnInfo02}}</span> </p>
                </button>
            </div>
        </div>

    ...
    <div class="privacy">
        <div class="main">
            <header>隐私条款</header>
             <div class="one">
                 <h3>一、双方</h3>
                 <p>1.1 Sesame Software Holdings（以下称“公司”）是一家根据新加坡共和国相关法律在新加坡共和国注册成立的公司，该公司运营网站http://www.Royalbiz.co（以下称“本网站”或“网站”），该网站是一个专门供用户进行数字资产交易和提供相关服务（以下称“该服务”或“服务”）的平台。为了本协议表述之方便，公司和该网站在本协议中合称使用“我们”或其他第一人称称呼。</p>
            ...
            <div class="one">
             ...
             <div class="one">
                 <h3>九、与我们的沟通</h3>
                 <p>
                     9.1 如果您有任何要求和意见，您可以通过电子邮件support@Royalbiz.co，这是属于我们与您沟通的唯一有效和官方电子邮件，所以我们对您未使用有效的联系方式，任何作为或不作为不承担责任。
                 </p>
                 <p>

<template>
    <div class="user">
        <div class="main">
            <header>用户协议</header>
            <!-- <h3>通过使用本网站，注册环球支付平台帐户或使用我们的任何其他环球支付平台服务，您同意接受并遵守条款和使用条款。 </h3> -->
            ...
            <!-- <p>接受使用条款</p>
            <p>通过使用本网站（“网站”），注册环球支付平台帐户（“帐户”）或使用我们的任何其他环球支付平台服务，您同意接受并遵守条款和使用条款。在使用本网站或任何环球支付平台服务之前，请仔细阅读完整的使用条款。本使用条款中使用的“环球支付平台”是指环球支付平台 Limited，包括但不限于其所有者，董事，投资者，员工或其他相关方。根据上下文，“环球支付平台”也可以指服务，产品，网站，内容或其他材料（统称为“环球支付平台服务”）。</p>  -->
             <div class="one">
                 <h3>重要提示：</h3>
                 <h3>我们在此特别提醒您：</h3>
                 ...
                 <p>（2）如有变动，及时更新用户资料。如果用户提供的注册资料不合法、不真实、不准确的，用户需承担因此引起的相应责任及后果，并且环球支付平台保留终止用户使用环球支付平台各项服务的权利。</p> -->
                 <p>
            ...
            <div class="one">
                ...
                <!-- <p class="psan">（1）停止使用环球支付平台的网络服务。</p>
                <p class="psan">（2）通过客服、支持等渠道告知环球支付平台停止对其服务。结束服务后，用户使用环球支付平台网络服务条款的权利立即终止。在此情况下，环球支付平台没有义务传送任何未处理的消息或未完成的服务给用户或任何无直接关系的第三方。 </p> -->
            </div>
            <div class="one">
                <h3>一、总则</h3>
